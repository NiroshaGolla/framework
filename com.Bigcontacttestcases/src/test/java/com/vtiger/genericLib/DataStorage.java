...
public class DataStorage 
{
	...
	{
		fis=new FileInputStream("D:\\Selenium framwork\\Data\\commonData.properties.properties");
		pobj.load(fis);
	...
	{
		FileInputStream fis=new FileInputStream("D:\\Selenium framwork\\Data\\Exceldata.xlsx");
