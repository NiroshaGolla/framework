...
public class WebDriverCommonUtils 
{
	String mainId;
	String childId;
	public void waitForElementToBeVisible(By locatorValue)
	{
		WebDriverWait wait=new WebDriverWait(BaseClass.driver,20);
		wait.until(ExpectedConditions.visibilityOfElementLocated(locatorValue));
	}
	public void waitForAllElementToBeVisible(By locatorValue)
	{
		WebDriverWait wait=new WebDriverWait(BaseClass.driver,20);
		wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(locatorValue));
	}

	public void pickItemAutoSuggestion(List<WebElement>suggestionList,String item)
	{
	...
	public void validateAlertMsg(String expMsg)
	{
		...
		System.out.println("Alert validate sucessfully");
	}
